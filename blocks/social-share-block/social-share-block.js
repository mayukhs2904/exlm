...
export default function decorate(block) {
  ...
  const socialIcons = {
    Facebook: htmlToElement(`<img src="${facebookSvg}" alt="Facebook Icon">`),
    LinkedIn: htmlToElement(`<img src="${linkedInSvg}" alt="LinkedIn Icon">`),
    'X (formerly Twitter)': htmlToElement(`<img src="${twitterSvg}" alt="Twitter Icon">`),
  };
